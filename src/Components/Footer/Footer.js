...
const Footer = () => {
    return (
        <div className='mt-[29px] bg-[#9FB846] h-[507px] relative overflow-hidden'>
            ...
            <div className='mx-[10%] flex justify-between items-center gap-[335px] pt-[23px]'>
            ...
            <div className='mt-[24px] mx-[10%] hr-line  ' />


            <div className='mx-[10%] mt-[25px] flex justify-between'>
            ...
            <div className='mt-[68px] mx-[10%] hr-line  ' />

            <p className='copyright mx-[10%] text-right '>Copyright@microbuddy.com. All Rights Reserved</p>
